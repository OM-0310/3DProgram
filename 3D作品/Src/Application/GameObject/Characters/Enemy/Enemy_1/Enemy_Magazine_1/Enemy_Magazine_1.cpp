#include "Enemy_Magazine_1.h"

#include "../Enemy_1.h"

void Enemy_Magazine_1::Init()
{
...
void Enemy_Magazine_1::PostUpdate()
{
	m_spAnimator->AdvanceTime(m_spModel->WorkNodes());
}

void Enemy_Magazine_1::DrawLit()
{
	if (!m_spModel)return;
...
void Enemy_Magazine_1::GenerateDepthMapFromLight()
{
	if (!m_spModel)return;
