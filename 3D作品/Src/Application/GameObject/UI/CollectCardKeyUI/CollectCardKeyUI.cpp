#include "CollectCardKeyUI.h"

void CollectCardKeyUI::Init()
{
	UIBase::SetAsset("Asset/Textures/UI/CardKey/CollectCardKeyUI/CollectCardKeyUI.png");
...
void CollectCardKeyUI::DrawSprite()
{
