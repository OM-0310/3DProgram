#include "Enemy_Main_3.h"

#include "../Enemy_3.h"

#include "../../../../../main.h"

void Enemy_Main_3::Init()
{
	...
	m_pCollider->RegisterCollisionShape("Enemy_Main_3Collision", m_spModel, KdCollider::TypeDamage);
}

void Enemy_Main_3::Update()
{
...
void Enemy_Main_3::PostUpdate()
{
	m_spAnimator->AdvanceTime(m_spModel->WorkNodes());
	m_spModel->CalcNodeMatrices();
}

void Enemy_Main_3::DrawLit()
{
	if (!m_spModel)return;
...
void Enemy_Main_3::GenerateDepthMapFromLight()
{
	if (!m_spModel)return;
