...
#include "Enemy_Main_2/Enemy_Main_2.h"
#include "Enemy_Gun_2/Enemy_Gun_2.h"
#include "Enemy_Gun_NoMagazine_2/Enemy_Gun_NoMagazine_2.h"
#include "Enemy_Magazine_2/Enemy_Magazine_2.h"
...
void Enemy_2::ChangeAnimation(const std::string& _animeName, bool _isLoop, float _time)
{
	const std::shared_ptr<Enemy_Main_2>			spEnemy_Main				= m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_2>			spEnemy_Gun					= m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Gun_NoMagazine_2>spEnemy_Gun_NoMagazine		= m_wpEnemy_Gun_NoMagazine.lock();
	const std::shared_ptr<Enemy_Magazine_2>		spEnemy_Magazine			= m_wpEnemy_Magazine.lock();
...
void Enemy_2::ActionIdle::Enter(Enemy_2& _owner)
{
	// 敵の状態が"停止状態"でないとき
...
void Enemy_2::ActionIdle::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Gun_2>	spGun = _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_2>	spEnemy_Main = _owner.m_wpEnemy_Main.lock();
...
void Enemy_2::ActionWalk::Enter(Enemy_2& _owner)
{
	// 敵の状態が"歩行状態"でないとき
...
void Enemy_2::ActionWalk::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Gun_2>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_2>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
...
void Enemy_2::ActionWalk::Exit(Enemy_2& _owner)
{
	_owner.m_spWalkSound->Stop();
}

void Enemy_2::ActionDiscover::Enter(Enemy_2& _owner)
{
...
void Enemy_2::ActionDiscover::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionRun::Enter(Enemy_2& _owner)
{
	// 敵の状態が"走行状態"でないとき
...
void Enemy_2::ActionRun::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Gun_2>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_2>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionRun::Exit(Enemy_2& _owner)
{
	_owner.m_spRunSound->Stop();
}

void Enemy_2::ActionReady::Enter(Enemy_2& _owner)
{
	// 敵の状態が"構え状態"でないとき
...
void Enemy_2::ActionReady::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Gun_2>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_2>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionShot::Enter(Enemy_2& _owner)
{
	// 敵の状態が"弾発射状態"でないとき
...
void Enemy_2::ActionShot::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Gun_2>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_2>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionShot::Exit(Enemy_2& _owner)
{
	_owner.m_spShotSound->Stop();
}

void Enemy_2::ActionAressted::Enter(Enemy_2& _owner)
{
	// 敵の状態が"拘束状態"でないとき
...
void Enemy_2::ActionAressted::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionAressted_Death::Enter(Enemy_2& _owner)
{
	// 敵の状態が"拘束状態"でないとき
...
void Enemy_2::ActionAressted_Death::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_2::ActionReload::Enter(Enemy_2& _owner)
{
	// 敵の状態が"リロード状態"でないとき
...
void Enemy_2::ActionReload::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Main_2>				spMain				= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_2>				spGun				= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Magazine_2>			spMagazine			= _owner.m_wpEnemy_Magazine.lock();
	const std::shared_ptr<Enemy_Gun_NoMagazine_2>	spGun_NoMagazine	= _owner.m_wpEnemy_Gun_NoMagazine.lock();
...
void Enemy_2::ActionReload::Exit(Enemy_2& _owner)
{
	_owner.m_spMgznRlsSound->Play();
}

void Enemy_2::ActionDeath::Enter(Enemy_2& _owner)
{
	// 敵の状態が"死亡状態"でないとき
...
void Enemy_2::ActionDeath::Update(Enemy_2& _owner)
{
	const std::shared_ptr<Enemy_Main_2>				spEnemy_Main			= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_2>				spEnemy_Gun				= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Gun_NoMagazine_2>	spEnemy_Gun_NoMagazine	= _owner.m_wpEnemy_Gun_NoMagazine.lock();
	const std::shared_ptr<Enemy_Magazine_2>			spEnemy_Magazine		= _owner.m_wpEnemy_Magazine.lock();
