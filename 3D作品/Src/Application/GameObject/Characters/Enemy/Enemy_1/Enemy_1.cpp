...
#include "Enemy_Main_1/Enemy_Main_1.h"
#include "Enemy_Gun_1/Enemy_Gun_1.h"
#include "Enemy_Gun_NoMagazine_1/Enemy_Gun_NoMagazine_1.h"
#include "Enemy_Magazine_1/Enemy_Magazine_1.h"
...
void Enemy_1::ChangeAnimation(const std::string& _animeName, bool _isLoop, float _time)
{
	const std::shared_ptr<Enemy_Main_1>			spEnemy_Main				= m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_1>			spEnemy_Gun					= m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Gun_NoMagazine_1>	spEnemy_Gun_NoMagazine	= m_wpEnemy_Gun_NoMagazine.lock();
	const std::shared_ptr<Enemy_Magazine_1>		spEnemy_Magazine			= m_wpEnemy_Magazine.lock();
...
void Enemy_1::ActionIdle::Enter(Enemy_1& _owner)
{
	// 敵の状態が"停止状態"でないとき
...
void Enemy_1::ActionIdle::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Gun_1>	spGun = _owner.m_wpEnemy_Gun.lock();
...
void Enemy_1::ActionWalk::Enter(Enemy_1& _owner)
{
	// 敵の状態が"歩行状態"でないとき
...
void Enemy_1::ActionWalk::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Gun_1>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_1>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
...
void Enemy_1::ActionDiscover::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionRun::Enter(Enemy_1& _owner)
{
	// 敵の状態が"走行状態"でないとき
...
void Enemy_1::ActionRun::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Gun_1>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_1>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionReady::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Gun_1>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_1>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionShot::Enter(Enemy_1& _owner)
{
	// 敵の状態が"弾発射状態"でないとき
...
void Enemy_1::ActionShot::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Gun_1>	spGun			= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Main_1>	spEnemy_Main	= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Player>		spPlayer		= _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionAressted::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionAressted_Death::Enter(Enemy_1& _owner)
{
	// 敵の状態が"拘束状態"でないとき
...
void Enemy_1::ActionAressted_Death::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Player> spPlayer = _owner.m_wpPlayer.lock();
...
void Enemy_1::ActionReload::Enter(Enemy_1& _owner)
{
	// 敵の状態が"リロード状態"でないとき
...
void Enemy_1::ActionReload::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Main_1>				spMain				= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_1>				spGun				= _owner.m_wpEnemy_Gun.lock();
...
void Enemy_1::ActionDeath::Update(Enemy_1& _owner)
{
	const std::shared_ptr<Enemy_Main_1>				spEnemy_Main			= _owner.m_wpEnemy_Main.lock();
	const std::shared_ptr<Enemy_Gun_1>				spEnemy_Gun				= _owner.m_wpEnemy_Gun.lock();
	const std::shared_ptr<Enemy_Gun_NoMagazine_1>	spEnemy_Gun_NoMagazine	= _owner.m_wpEnemy_Gun_NoMagazine.lock();
	const std::shared_ptr<Enemy_Magazine_1>			spEnemy_Magazine		= _owner.m_wpEnemy_Magazine.lock();
