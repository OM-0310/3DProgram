#include "MapUpdateUIBack.h"

void MapUpdateUIBack::Init()
{
	UIBase::SetAsset("Asset/Textures/UI/MapUpdateUIBack/MapUpdateUIBack.png");
...
void MapUpdateUIBack::DrawSprite()
{
