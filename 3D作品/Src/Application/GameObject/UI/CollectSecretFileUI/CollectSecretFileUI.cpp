#include "CollectSecretFileUI.h"

void CollectSecretFileUI::Init()
{
	UIBase::SetAsset("Asset/Textures/UI/SecretFile/CollectSecretFileUI/CollectSecretFileUI.png");
...
void CollectSecretFileUI::Update()
{
...
void CollectSecretFileUI::DrawSprite()
{
