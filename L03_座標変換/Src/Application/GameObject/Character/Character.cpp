...
{
	Math::Vector2 charaPos;
	charaPos = { m_mWorld.Translation().x / 1280,m_mWorld.Translation().z / 720};
	KdShaderManager::Instance().m_spriteShader.DrawCircle(charaPos.x, charaPos.y, 10, &kRedColor);
}
